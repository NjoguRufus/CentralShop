            ...
            <div className="xl:col-span-2 p-6">
              <div className="max-w-2xl mx-auto">
                ...
                {settingsLoading ? (
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-1 justify-center flex-nowrap sm:flex-wrap sm:justify-center sm:overflow-visible">
                        ...
                        <button
                          ...
                          >
                            <div className="flex flex-col items-center space-y-1.5">
                              ...
                              <span className="text-[11px] font-medium text-center leading-tight">{method.label}</span>
                            </div>
                            {paymentMethod === method.value && (
